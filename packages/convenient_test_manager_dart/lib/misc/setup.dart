...
import 'package:convenient_test_manager_dart/services/noop_vm_service_wrapper_service.dart';
...
Future<void> setup({
  ...
  if (registerVmServiceWrapper) {
    getIt.registerSingleton<VmServiceWrapperService>(supportsIoPlatform
